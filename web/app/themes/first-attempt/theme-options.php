...
class TemplateToaster_Theme_Options extends TemplateToaster_Theme_Options_Dynamic
{
    ...
    public function __construct()
    {
        ...
        $this->sections['error'] = __('Error Page', "first-attempt");
        $this->sections['maintenance'] = __('Maintenance', "first-attempt");
        $this->sections['shortcodes'] = __('Shortcode', "first-attempt");
        $this->sections['googlemap'] = __('GoogleMap', "first-attempt");
        //$this->sections['contactus'] = __('Contact Us', "first-attempt");
		// $this->sections['seo'] = __('SEO', "first-attempt");
        $this->sections['backuppage'] = __('Backup/Recovery', "first-attempt");
        $this->sections['export_import'] = __('Export/Import Theme Options', "first-attempt");
        $fileName = get_template_directory() . '/content/imports.php';
		if ( file_exists( $fileName ) ) { 
        $this->sections['import_content'] = __('Import Content', "first-attempt"); 
        }
    ...
    public function create_setting($args = array())
    {
        ...
        $defaults = array(
            'id' => 'default_field',
            'title' => __('Default Field', "first-attempt"),
            'desc' => __('This is a default description.', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'section' => 'general',
            'choices' => array(),
    ...
    public function display_page()
    {
       ...
       //display URl error message 
        ...
        {
            echo '<div class="updated fade"><p>' . __('Theme options updated.', "first-attempt") . '</p></div>';
		}
        echo '<div id="admin_container" class="wrap">
	            <div class="icon-option"> </div>
	            <h1>' . __('Theme Options For', "first-attempt") . '&nbsp;' . $themename . '</h1><br/>';
		...
		echo '</div>';
		echo '<p class="submit">' .
            get_submit_button(__('Save Options', "first-attempt"), 'button-primary', 'ttr_submit', false). '</p>';			
		echo '</form>';
        echo '</div>';
    }
       ...
       <div id="content">
                ...
                ?>
                    <table class="table">
                        <tbody>
                        <tr>
                            <td colspan="3"><?php echo(__("To use CONTACT FORM, apply shortcode [contact_us_form]","first-attempt"));?></td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Admin Email Address',"first-attempt"));?></td>
                            <td colspan="2">
                        ...
                        <!-- Google Captcha -->
                        <tr>
                            <td><?php echo(__('Public Key For Google Captcha',"first-attempt"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Private Key For Google Captcha',"first-attempt"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Error Message',"first-attempt"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_error_message" <?php if($value_contact[3]['ttr_contact_us_error_message']){ ?> value="<?php print_r($value_contact[3]['ttr_contact_us_error_message']); ?>" <?php } else {?> value="<?php echo(__("Message was not sent. Try Again.","first-attempt"));?>"<?php } ?> name="ttr_contact_us_error_message" />
                        ...
                        <tr>
                            <td><?php echo(__('Success Message',"first-attempt"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_success_message" <?php if($value_contact[4]['ttr_contact_us_success_message']){ ?> value="<?php print_r($value_contact[4]['ttr_contact_us_success_message']); ?>" <?php } else {?> value="<?php echo(__("Thanks! Your message has been sent.","first-attempt")); ?>"<?php } ?>  name="ttr_contact_us_success_message" />

                            </td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Field Name:',"first-attempt"));?></td>
                           <!-- <td><?php echo(__('Field Type:',"first-attempt"));?></td>-->
                            <td><?php echo(__('Required',"first-attempt"));?></td>
                            <td><?php echo(__('Remove',"first-attempt"));?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><input type="button" value="<?php echo(__('Add New Field',"first-attempt"));?>" class="newfield button-secondary" /></td>
                        </tr>
...
<?php
  ...
  /*  public function display_seoenable_section()
    ...
    public function display_backuppage_section()
    {
        ...
        $this->sections['backupsettings'] = __('Settings', "first-attempt");
        $this->sections['backup'] = __('Backup', "first-attempt");
        $this->sections['restore'] = __('Restore', "first-attempt");
	...
	?>
		<table class="form-table">
	    	<tbody>
	    		<tr>
		            <th>
		            <label><?php echo(__('Export theme options','first-attempt'));?></label>
					</th><td>	            
	            	<input id="export_yes" class="button button-primary" type="button" name="exportt" value="<?php echo(__('Export Theme Option','first-attempt'));?>" />	            	
	                </td>
	            </tr>
	            <tr>
	               <th>	               
	                <label id="select_file"><?php echo(__('Import theme options? ','first-attempt'));?></label>
	                </th><td>
			       	<input type="file" name="importfile" id="importfile" style="height:auto;">
			       	<input id="import_options_yes" class="button button-primary" type="button" value="<?php echo(__('Import Theme Options','first-attempt'));?>" name="import_options">			       
	                </td>
	            </tr>
			</tbody>
	    </table>
       ...
       if (!get_option('TemplateToaster_theme_options'))
        ...
        switch ($type) {
            ...
            case 'media':
                ...
                echo '&nbsp;<input type="button" class="ttrbutton btn" value="' . __('Upload', "first-attempt") . '"/>';
                if ($desc != '')
                    echo '<br /><span class="description">' . $desc . '</span>';
    ...
    public function get_static_options()
    {
       ...
       /* Error page Settings
        ...
        $this->settings['ttr_error_message_heading'] = array(
            'title' => __('Heading For Error Message', "first-attempt"),
            'desc' => __('Change Text For Error Message', "first-attempt"),
            'std' => __('This is somewhat embarrassing, isn&rsquo;t it?', "first-attempt"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message_content'] = array(
            'title' => __('Content For Error Message', "first-attempt"),
            'desc' => __('Change text For Error Message', "first-attempt"),
            'std' => __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', "first-attempt"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message'] = array(
            'title' => __('Enable Content', "first-attempt"),
            'desc' => __('Hide/Show Error Message Text', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_search_box'] = array(
            'title' => __('Enable Search', "first-attempt"),
            'desc' => __('Hide/Show Search Box', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image'] = array(
            'title' => __('Content Image', "first-attempt"),
            'desc' => __('Choose Error Image', "first-attempt"),
            'std' => '',
            'type' => 'media',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_enable'] = array(
            'title' => __('Enable Image In Content', "first-attempt"),
            'desc' => __('Hide/Show error image', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_height'] = array(
            'title' => __('Content Image Height', "first-attempt"),
            'desc' => __('Height Of The Error Image', "first-attempt"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_image_width'] = array(
            'title' => __('Content Image Width', "first-attempt"),
            'desc' => __('Width of The Error Image', "first-attempt"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_home_redirect'] = array(
            'title' => __('Redirect To Home Page(If Error Page Occurs)', "first-attempt"),
            'desc' => __('Redirect to Home Page While Error Occur', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        ...
        $this->settings['ttr_mm_enable'] = array(
            'title' => __('Enable Maintenance Mode', "first-attempt"),
            'desc' => __('Enable/Disable Maintenance Mode', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_title'] = array(
            'title' => __('Title for Maintenance Mode Page', "first-attempt"),
            'desc' => __('Set the Title', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_content'] = array(
            'title' => __('Content for Maintenance Mode Page', "first-attempt"),
            'desc' => __('Content for Maintenance Mode page', "first-attempt"),
            'std' => '',
            'type' => 'textarea',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_image'] = array(
            'title' => __('Background Image for Maintenance Mode', "first-attempt"),
            'desc' => __('Select Image for Maintenance Mode Page', "first-attempt"),
            'std' => '',
            'type' => 'media',
            'section' => 'maintenance'
        );
        ...
        $this->settings['ttr_googlemap_type'] = array(
            'title' => __('Choose the type of Google Map', "first-attempt"),
            'desc' => __('Choose the type of Google Map', "first-attempt"),
            'type' => 'select',
            'std' => 'Road',
            'choices' => array(
                'choice1' => __('ROAD', "first-attempt"),
                'choice2' => __('SATELLITE', "first-attempt"),
                'choice3' => __('HYBRID', "first-attempt"),
                'choice4' => __('TERRAIN', "first-attempt")),
            'section' => 'googlemap'
        );
       $this->settings['ttr_map_latitude'] = array(
            'title' => __('Set Latitude', "first-attempt"),
            'desc' => __('Set Latitude', "first-attempt"),
            'std' => '25.306944',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_longitude'] = array(
            'title' => __('Set Longitude', "first-attempt"),
            'desc' => __('Set Longitude', "first-attempt"),
            'std' => '-257.858333',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_width'] = array(
            'title' => __('Set Width of Map', "first-attempt"),
            'desc' => __('Set Width of Map', "first-attempt"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_height'] = array(
            'title' => __('Set Height of Map', "first-attempt"),
            'desc' => __('Set Height of Map', "first-attempt"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_marker_enable'] = array(
            'title' => __('Display Marker', "first-attempt"),
            'desc' => __('Enable/Disable the Position Marker', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'googlemap'
        );
        $this->settings['ttr_marker_text'] = array(
            'title' => __('Set Marker Label', "first-attempt"),
            'desc' => __('Set Marker Label', "first-attempt"),
        ...
        $this->settings['ttr_googlemap_api'] = array(
            'title' => __('Set Google API Key', "first-attempt"),
            'desc' => __('Set Google API Key', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'patter' => '\d+',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_google_docs_viewer_shortcode'] = array(
            'title' => __('Google Docs Viewer', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_displaying_recent_posts_shortcode'] = array(
            'title' => __('Displaying Related Posts', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
            'std' => '[related_posts]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_adsense_shortcode'] = array(
            'title' => __('Google AdSense', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_google_chart_shortcode'] = array(
            'title' => __('Google Chart', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tweet_me_button_shortcode'] = array(
            'title' => __('Tweet Me Button', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
            'std' => '[tweet]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_map_shortcode'] = array(
            'title' => __('Google Map', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
            'std' => '[googlemap]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_youtube_shortcode'] = array(
            'title' => __('YouTube', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_private_content_shortcode'] = array(
            'title' => __('Private Content', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        /*$this->settings['ttr_contact_us_form_shortcode'] = array(
            'title' => __('Contact Us Form', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
            'std' => '[contact_us_form]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_login_form_shortcode'] = array(
            'title' => __('Login Form', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_custommenu_shortcode'] = array(
            'title' => __('Custom Menu', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_archives_shortcode'] = array(
            'title' => __('Archives', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_calendar_shortcode'] = array(
            'title' => __('Calendar', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_categories_shortcode'] = array(
            'title' => __('Categories', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_comments_shortcode'] = array(
            'title' => __('Recent Comments', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_posts_shortcode'] = array(
            'title' => __('Recent Posts', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tagcloud_shortcode'] = array(
            'title' => __('Tag Cloud', "first-attempt"),
            'desc' => __('To use Copy/Paste the above shortcode', "first-attempt"),
            'type' => 'shortcode',
       ...
       ===========================================*/
        ...
        $this->settings['ttr_ftp_server_address'] = array(
            'title' => __('FTP Server Address', "first-attempt"),
            'desc' => __('Enter the FTP Address ', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_name'] = array(
            'title' => __('FTP User name', "first-attempt"),
            'desc' => __('Enter the FTP username ', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_password'] = array(
            'title' => __('FTP User password', "first-attempt"),
            'desc' => __('Enter the FTP password ', "first-attempt"),
            'std' => '',
            'type' => 'password',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_recipient_email'] = array(
            'title' => __('Email of recipient', "first-attempt"),
            'desc' => __('Enter the name of email recipient ', "first-attempt"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_check_connection'] = array(
            'title' => __('Check FTP Connection', "first-attempt"),
            'desc' => __('Click to check the FTP Connection Status', "first-attempt"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_manual_database_backup'] = array(
            'title' => __('Database Backup (.sql file)', "first-attempt"),
            'desc' => __('Add/Remove database (.sql) file to Backup zip', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_recovery_enable'] = array(
            'title' => __('Enable Automatic Backup/Recovery Mode)', "first-attempt"),
            'desc' => __('Enable/Disable Automatic Backup/Recovery Mode', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_plugin_backup'] = array(
            'title' => __('Include Plugins', "first-attempt"),
            'desc' => __('Include/Exclude plugins to Backup Zip', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_theme_backup'] = array(
            'title' => __('Include Themes', "first-attempt"),
            'desc' => __('Include/Exclude themes to Backup Zip', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_uploads_backup'] = array(
            'title' => __('Include Uploads', "first-attempt"),
            'desc' => __('Include/Exclude uploads to Backup Zip', "first-attempt"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "first-attempt"),
            'desc' => __('Set the folder name to take the backup', "first-attempt"),
            'std' => 'Backup',
            'type' => 'text',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_interval'] = array(
            'title' => __('Automatic Backup intervals', "first-attempt"),
            'desc' => __('Select the database interval to take backup', "first-attempt"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('Every 10 mins', "first-attempt"),
                'choice2' => __('Every hour', "first-attempt"),
                'choice3' => __('Every 4 hours', "first-attempt"),
                'choice4' => __('Every 8 hours', "first-attempt"),
                'choice2' => __('Every 12 hours', "first-attempt"),
                'choice3' => __('Daily', "first-attempt"),
                'choice4' => __('Weekly', "first-attempt")),
            'section' => 'backup'
        );
        $this->settings['ttr_storage_backup'] = array(
            'title' => __('Choose your Remote Storage', "first-attempt"),
            'desc' => __('Set time to the backup', "first-attempt"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('FTP', "first-attempt"),
                'choice2' => __('Email', "first-attempt")),
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "first-attempt"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_browse'] = array(
            'title' => __('Select Backup Folder', "first-attempt"),
            'desc' => __('Select the folder(.zip file only)', "first-attempt"),
            'std' => '',
            'type' => 'file',
            'section' => 'restore'
        );
        $this->settings['ttr_include_database_restore'] = array(
            'title' => __('Restore Database(.sql)', "first-attempt"),
            'desc' => __('Enable/Disable to restore databases for Site', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_theme_restore'] = array(
            'title' => __('Restore Themes', "first-attempt"),
            'desc' => __('Enable/Disable to restore theme folder for Site', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_plugins_restore'] = array(
            'title' => __('Restore Plugins', "first-attempt"),
            'desc' => __('Enable/Disable to restore plugins folder for Site', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_uploads_restore'] = array(
            'title' => __('Restore Uploads', "first-attempt"),
            'desc' => __('Enable/Disable to restore uploads folder for Site', "first-attempt"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
    ...
    public function scripts()
    {
        ...
        $translations = array_merge(array('tt_xmlerror' => (__('Please, select an xml file','first-attempt')), 'tt_savechanges' => (__('No changes to export in Theme Options. Please save your changes properly.','first-attempt'))));
    ...
    public function validate_settings($input)
    {
        ...
        foreach ($this->settings as  $key => $value)
        {
 			if($key == 'ttr_designedby_link_url')
            {
               ...
               { 
                 add_settings_error('templatetoaster_theme_options','errorMsg',__("Please enter a valid URL", "first-attempt"),'error') ;
			     return $options;
              }             
            }
