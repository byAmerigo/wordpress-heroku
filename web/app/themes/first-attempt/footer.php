...
<?php
if( is_active_sidebar( 'footercellcolumn1'  ) || is_active_sidebar( 'footercellcolumn2'  ) || is_active_sidebar( 'footercellcolumn3'  )):
?>
...
<?php else: ?>
<div class="cell2 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12 transparent">
&nbsp;
</div> <!-- topcell 2 column-->
<?php endif; ?>
<div class=" visible-sm-block d-sm-block visible-xs-block d-block" style="clear:both;"></div>
...
<?php templatetoaster_theme_dynamic_sidebar( 'abc22'); ?>
</div>
</div> <!-- top child column close-->
</div>  <!-- topcell column-->
<?php else: ?>
...
<?php $footer_link="http://templatetoaster.com"?>
