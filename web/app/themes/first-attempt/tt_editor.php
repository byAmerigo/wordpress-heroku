...
$fontformats  = explode(",",'PT Sans,Rosario,Roboto,Rosario,Arial,Georgia,<String xmlns="clr-namespace:System;assembly=mscorlib">&lt;String xmlns="clr-namespace:System;assembly=mscorlib"&gt;&amp;lt;String xmlns="clr-namespace:System;assembly=mscorlib"&amp;gt;&amp;amp;lt;String xmlns="clr-namespace:System;assembly=mscorlib"&amp;amp;gt;&amp;amp;amp;lt;String xmlns="clr-namespace:System;assembly=mscorlib"&amp;amp;amp;gt;Arial&amp;amp;amp;lt;/String&amp;amp;amp;gt;&amp;amp;lt;/String&amp;amp;gt;&amp;lt;/String&amp;gt;&lt;/String&gt;</String>,PT Sans,Cooper Std');
...
<li role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab1" href="#tt_editor_tab1" role="tab" >' . __( 'Default Editor','first-attempt') . '</a></li>
<li class="active" role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab2" href="#tt_editor_tab2" role="tab">' . __( 'Custom Editor','first-attempt') . '</a></li>
</ul>';
