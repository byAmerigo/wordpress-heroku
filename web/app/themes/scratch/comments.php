...
<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'scratch' ); ?></p>
</div>
<?php
return;
endif;
...
<?php
printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'scratch' ),
...
<h1 class="assistive-text"><?php _e( 'Comment navigation', 'scratch' ); ?></h1>
...
<p class="nocomments"><?php _e( 'Comments are closed.', 'scratch' ); ?></p>
<?php } ?>
<?php endif; ?>
